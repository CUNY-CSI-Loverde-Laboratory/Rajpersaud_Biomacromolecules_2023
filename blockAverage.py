...
def blockAverage(datastream, isplot=True, maxBlockSize=0):
	...
	https://gist.github.com/shane5ul/6289436ace018e6e9e79ee3489be2b8f#file-blockaverage-py
	OWNER:shane5ul from github
	"""
	...
	for blockSize in range(minBlockSize, maxBlockSize):
		...
		for i in range(1,Nblock+1):
			...
			ibeg = (i-1) * blockSize
			iend =  ibeg + blockSize
			obsProp[i-1] = np.mean(datastream[ibeg:iend],axis=0)
